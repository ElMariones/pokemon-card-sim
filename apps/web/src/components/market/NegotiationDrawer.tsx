  ...
  return (
    <div className="fixed inset-0 z-50 bg-ink/78 backdrop-blur-sm" onClick={(event) => {
      ...
      <section
        ...
        className="negotiation-drawer pane absolute inset-x-0 bottom-0 max-h-[94dvh] overflow-y-auto rounded-t-[18px] p-5 sm:inset-y-0 sm:right-0 sm:left-auto sm:max-h-none sm:w-[min(760px,92vw)] sm:rounded-none sm:border-y-0 sm:border-r-0 sm:p-7"
      >
