...
const SECTIONS: { game: MinigameId; title: string; note: string }[] = [
  ...
  { game: "snake", title: "Who leads the parade", note: "Poké Snake. The head of your snake is the one you choose; everything that joins the tail comes from the meadow itself." },
